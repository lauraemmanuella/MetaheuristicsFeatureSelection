...
public class Classificador implements Runnable {
    ...
    private final FeatureSelectionHybrid fs;
    ...
    public Classificador(Classifier model, ArrayList<Integer> selecionados, String nomeBase,
        ...
        this.model = model;
        fs = new FeatureSelectionHybrid(nomeBase, nomeClassificador);
    ...
    public void run() {
        try {
            ...
            System.out.println("Erro em construir classificador: " + e.getMessage());
            acuracia = -1;
        }
    }
